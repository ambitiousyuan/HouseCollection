 ...
 */
package com.hnshengen.housecollection.house.core.common.constant.factory;
...
import com.hnshengen.housecollection.house.modular.system.entity.*;
import com.hnshengen.housecollection.house.modular.system.mapper.*;
...
public class ConstantFactory implements IConstantFactory {
    ...
    public List<Dict> getDict() {
		List<Dict> cacheDict = null;
		/*Object obj = CacheUtil.get(Cache.CONSTANT, CacheKey.DICTS);
		if (ToolUtil.isNotEmpty(obj)) {
			cacheDict = (List<Dict>) obj;
			return cacheDict;
		} else {
			cacheDict = dictMapper.selectList(new LambdaQueryWrapper<>());
			CacheUtil.put(Cache.CONSTANT, CacheKey.DICTS, cacheDict);
		}暂不用*/
		return cacheDict;
	}
