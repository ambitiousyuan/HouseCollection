 ...
 */
package com.hnshengen.housecollection.house.core.metadata;
...
public class CustomMetaObjectHandler implements MetaObjectHandler {
    ...
    public void insertFill(MetaObject metaObject) {
        ...
        Object comId = getFieldValByName(getComIdFieldName(), metaObject);
        if (comId == null) {

        	//获取当前登录用户
        	Object comIdUser = getUserComId();
        	
        	setFieldValByName(getComIdFieldName(), comIdUser, metaObject);
        }
    }
     ...
     * 获取创建用户字段的名称（非数据库中字段名称）
     */
    protected String getComIdFieldName() {
    	return "comId";
    }
    ...
    /**
     * 获取用户唯一comid（注意默认获取的用户唯一id为空，如果想填写则需要继承本类）
     */
    protected Object getUserComId() {
    	return "";
    }
}